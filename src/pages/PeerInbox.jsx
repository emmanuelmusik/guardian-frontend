...
export default function PeerInbox({ profile }) {
  ...
  useEffect(() => {
    apiFetch('/api/entries/shared-with-peer')
      .then(setEntries)
  ...
  return (
    <div style={styles.page}>
      ...
      {!loading && entries.length === 0 && (
        <p style={styles.dim}>No fellow aspirant has shared anything with you yet.</p>
      )}
